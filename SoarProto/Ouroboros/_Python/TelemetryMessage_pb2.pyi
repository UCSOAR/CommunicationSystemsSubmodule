...
class TelemetryMessage(_message.Message):
    __slots__ = ("source", "target", "gps", "baro", "imu", "battery", "flashState", "dmbPressure", "pbbPressure", "pbbTemperature", "combustionControlStatus", "rcuPressure", "rcuTemperature", "nosLoadCell", "relayStatus", "padBoxStatus", "launchRailLoadCell", "sobTemperature", "pressureLog")
...
class PressureLog(_message.Message):
    __slots__ = ("time", "pv_pressure", "ib_pressure")
    TIME_FIELD_NUMBER: _ClassVar[int]
