...
class FcbPressure final: public ::EmbeddedProto::MessageInterface
{
  public:
    FcbPressure() = default;
    FcbPressure(const FcbPressure& rhs )
    {
      set_upper_pv_pressure(rhs.get_upper_pv_pressure());
    }

    FcbPressure(const FcbPressure&& rhs ) noexcept
    {
      set_upper_pv_pressure(rhs.get_upper_pv_pressure());
    }

    ~FcbPressure() override = default;
    ...
    FcbPressure& operator=(const FcbPressure& rhs)
    {
      set_upper_pv_pressure(rhs.get_upper_pv_pressure());
      return *this;
    }

    FcbPressure& operator=(const FcbPressure&& rhs) noexcept
    {
      set_upper_pv_pressure(rhs.get_upper_pv_pressure());
      return *this;
    }
...
class FsbPressure final: public ::EmbeddedProto::MessageInterface
{
  public:
    FsbPressure() = default;
    FsbPressure(const FsbPressure& rhs )
    {
    ...
    FsbPressure(const FsbPressure&& rhs ) noexcept
    {
      set_pt1_pressure(rhs.get_pt1_pressure());
      set_pt2_pressure(rhs.get_pt2_pressure());
      set_pt3_pressure(rhs.get_pt3_pressure());
    ...
    FsbPressure& operator=(const FsbPressure& rhs)
    {
      set_pt1_pressure(rhs.get_pt1_pressure());
      set_pt2_pressure(rhs.get_pt2_pressure());
      set_pt3_pressure(rhs.get_pt3_pressure());
    ...
    FsbPressure& operator=(const FsbPressure&& rhs) noexcept
    {
      set_pt1_pressure(rhs.get_pt1_pressure());
      set_pt2_pressure(rhs.get_pt2_pressure());
      set_pt3_pressure(rhs.get_pt3_pressure());
...
class FsbTemperature final: public ::EmbeddedProto::MessageInterface
{
  public:
    FsbTemperature() = default;
    FsbTemperature(const FsbTemperature& rhs )
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
    }

    FsbTemperature(const FsbTemperature&& rhs ) noexcept
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
    }

    ~FsbTemperature() override = default;
    ...
    FsbTemperature& operator=(const FsbTemperature& rhs)
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
      return *this;
    ...
    FsbTemperature& operator=(const FsbTemperature&& rhs) noexcept
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
      return *this;
...
class HeaterStatus final: public ::EmbeddedProto::MessageInterface
{
  public:
...
class LrbTemperature final: public ::EmbeddedProto::MessageInterface
{
  public:
    LrbTemperature() = default;
    LrbTemperature(const LrbTemperature& rhs )
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
    }

    LrbTemperature(const LrbTemperature&& rhs ) noexcept
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
    }

    ~LrbTemperature() override = default;
    ...
    LrbTemperature& operator=(const LrbTemperature& rhs)
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
      return *this;
    ...
    LrbTemperature& operator=(const LrbTemperature&& rhs) noexcept
    {
      set_tc1_temperature(rhs.get_tc1_temperature());
      set_tc2_temperature(rhs.get_tc2_temperature());
      return *this;
...
class PbbTemperature final: public ::EmbeddedProto::MessageInterface
{
  public:
    ...
    inline void set_lower_pv_tc1(const int32_t&& value) { lower_pv_tc1_ = value; }
    inline int32_t& mutable_lower_pv_tc1() { return lower_pv_tc1_.get(); }
...
class TelemetryMessage final: public ::EmbeddedProto::MessageInterface
{
  public:
    ...
    TelemetryMessage(const TelemetryMessage& rhs )
    {
      ...
      switch(rhs.get_which_message())
      {
        ...
        case FieldNumber::FSBPRESSURE:
          set_fsbPressure(rhs.get_fsbPressure());
          break;

        case FieldNumber::FSBTEMPERATURE:
          set_fsbTemperature(rhs.get_fsbTemperature());
          break;
        ...
        case FieldNumber::LRBTEMPERATURE:
          set_lrbTemperature(rhs.get_lrbTemperature());
          break;
        ...
        case FieldNumber::HEATERSTATUS:
          set_heaterStatus(rhs.get_heaterStatus());
          break;
    ...
    static constexpr char const* FCBPRESSURE_NAME = "fcbPressure";
    inline bool has_fcbPressure() const
    {
      return FieldNumber::FCBPRESSURE == which_message_;
    }
    inline void clear_fcbPressure()
    {
      if(FieldNumber::FCBPRESSURE == which_message_)
      {
        which_message_ = FieldNumber::NOT_SET;
        message_.fcbPressure_.~FcbPressure();
      }
    }
    inline void set_fcbPressure(const FcbPressure& value)
    {
      if(FieldNumber::FCBPRESSURE != which_message_)
      {
        init_message(FieldNumber::FCBPRESSURE);
      }
      message_.fcbPressure_ = value;
    }
    inline void set_fcbPressure(const FcbPressure&& value)
    {
      if(FieldNumber::FCBPRESSURE != which_message_)
    ...
    inline FcbPressure& mutable_fcbPressure()
    {
      if(FieldNumber::FCBPRESSURE != which_message_)
      {
        init_message(FieldNumber::FCBPRESSURE);
      }
      return message_.fcbPressure_;
    }
    ...
    {
      return FieldNumber::FSBPRESSURE == which_message_;
    }
    inline void clear_fsbPressure()
    {
      if(FieldNumber::FSBPRESSURE == which_message_)
      {
        which_message_ = FieldNumber::NOT_SET;
        message_.fsbPressure_.~FsbPressure();
      }
    }
    inline void set_fsbPressure(const FsbPressure& value)
    {
      if(FieldNumber::FSBPRESSURE != which_message_)
      {
        init_message(FieldNumber::FSBPRESSURE);
      }
      message_.fsbPressure_ = value;
    }
    inline void set_fsbPressure(const FsbPressure&& value)
    {
      if(FieldNumber::FSBPRESSURE != which_message_)
    ...
    inline FsbPressure& mutable_fsbPressure()
    {
      if(FieldNumber::FSBPRESSURE != which_message_)
      {
        init_message(FieldNumber::FSBPRESSURE);
      }
      return message_.fsbPressure_;
    }
    inline const FsbPressure& get_fsbPressure() const { return message_.fsbPressure_; }
    inline const FsbPressure& fsbPressure() const { return message_.fsbPressure_; }

    static constexpr char const* FSBTEMPERATURE_NAME = "fsbTemperature";
    inline bool has_fsbTemperature() const
    {
      return FieldNumber::FSBTEMPERATURE == which_message_;
    }
    inline void clear_fsbTemperature()
    {
      if(FieldNumber::FSBTEMPERATURE == which_message_)
      {
        which_message_ = FieldNumber::NOT_SET;
        message_.fsbTemperature_.~FsbTemperature();
      }
    }
    inline void set_fsbTemperature(const FsbTemperature& value)
    {
      if(FieldNumber::FSBTEMPERATURE != which_message_)
      {
        init_message(FieldNumber::FSBTEMPERATURE);
      }
      message_.fsbTemperature_ = value;
    }
    inline void set_fsbTemperature(const FsbTemperature&& value)
    {
      if(FieldNumber::FSBTEMPERATURE != which_message_)
    ...
    inline FsbTemperature& mutable_fsbTemperature()
    {
      if(FieldNumber::FSBTEMPERATURE != which_message_)
      {
        init_message(FieldNumber::FSBTEMPERATURE);
      }
      return message_.fsbTemperature_;
    }
    inline const FsbTemperature& get_fsbTemperature() const { return message_.fsbTemperature_; }
    inline const FsbTemperature& fsbTemperature() const { return message_.fsbTemperature_; }
    ...
    static constexpr char const* LRBTEMPERATURE_NAME = "lrbTemperature";
    inline bool has_lrbTemperature() const
    {
      return FieldNumber::LRBTEMPERATURE == which_message_;
    }
    inline void clear_lrbTemperature()
    {
      if(FieldNumber::LRBTEMPERATURE == which_message_)
      {
        which_message_ = FieldNumber::NOT_SET;
        message_.lrbTemperature_.~LrbTemperature();
      }
    }
    inline void set_lrbTemperature(const LrbTemperature& value)
    {
      if(FieldNumber::LRBTEMPERATURE != which_message_)
      {
        init_message(FieldNumber::LRBTEMPERATURE);
      }
      message_.lrbTemperature_ = value;
    }
    inline void set_lrbTemperature(const LrbTemperature&& value)
    {
      if(FieldNumber::LRBTEMPERATURE != which_message_)
    ...
    inline LrbTemperature& mutable_lrbTemperature()
    {
      if(FieldNumber::LRBTEMPERATURE != which_message_)
      {
        init_message(FieldNumber::LRBTEMPERATURE);
      }
      return message_.lrbTemperature_;
    }
    ...
    static constexpr char const* HEATERSTATUS_NAME = "heaterStatus";
    inline bool has_heaterStatus() const
    {
      return FieldNumber::HEATERSTATUS == which_message_;
    }
    inline void clear_heaterStatus()
    {
      if(FieldNumber::HEATERSTATUS == which_message_)
      {
        which_message_ = FieldNumber::NOT_SET;
        message_.heaterStatus_.~HeaterStatus();
      }
    }
    inline void set_heaterStatus(const HeaterStatus& value)
    {
      if(FieldNumber::HEATERSTATUS != which_message_)
      {
        init_message(FieldNumber::HEATERSTATUS);
      }
      message_.heaterStatus_ = value;
    }
    inline void set_heaterStatus(const HeaterStatus&& value)
    {
      if(FieldNumber::HEATERSTATUS != which_message_)
    ...
    inline HeaterStatus& mutable_heaterStatus()
    {
      if(FieldNumber::HEATERSTATUS != which_message_)
      {
        init_message(FieldNumber::HEATERSTATUS);
      }
      return message_.heaterStatus_;
    }
    ...
    ::EmbeddedProto::Error serialize(::EmbeddedProto::WriteBufferInterface& buffer) const override
    {
      ...
      switch(which_message_)
      {
        ...
        case FieldNumber::FCBPRESSURE:
          if(has_fcbPressure() && (::EmbeddedProto::Error::NO_ERRORS == return_value))
          {
            return_value = message_.fcbPressure_.serialize_with_id(static_cast<uint32_t>(FieldNumber::FCBPRESSURE), buffer, true);
          }
          break;
        ...
        case FieldNumber::FSBPRESSURE:
          if(has_fsbPressure() && (::EmbeddedProto::Error::NO_ERRORS == return_value))
          {
            return_value = message_.fsbPressure_.serialize_with_id(static_cast<uint32_t>(FieldNumber::FSBPRESSURE), buffer, true);
          }
          break;

        case FieldNumber::FSBTEMPERATURE:
          if(has_fsbTemperature() && (::EmbeddedProto::Error::NO_ERRORS == return_value))
          {
            return_value = message_.fsbTemperature_.serialize_with_id(static_cast<uint32_t>(FieldNumber::FSBTEMPERATURE), buffer, true);
          }
          break;
        ...
        case FieldNumber::LRBTEMPERATURE:
          if(has_lrbTemperature() && (::EmbeddedProto::Error::NO_ERRORS == return_value))
          {
            return_value = message_.lrbTemperature_.serialize_with_id(static_cast<uint32_t>(FieldNumber::LRBTEMPERATURE), buffer, true);
          }
          break;
        ...
        case FieldNumber::HEATERSTATUS:
          if(has_heaterStatus() && (::EmbeddedProto::Error::NO_ERRORS == return_value))
          {
            return_value = message_.heaterStatus_.serialize_with_id(static_cast<uint32_t>(FieldNumber::HEATERSTATUS), buffer, true);
          }
          break;
    ...
    static char const* field_number_to_name(const FieldNumber fieldNumber)
    {
      ...
      switch(fieldNumber)
      {
        ...
        case FieldNumber::LAUNCHRAILLOADCELL:
          ...
          break;
        case FieldNumber::LRBTEMPERATURE:
          name = LRBTEMPERATURE_NAME;
          break;
        case FieldNumber::PRESSURELOG:
          name = PRESSURELOG_NAME;
          break;
        case FieldNumber::HEATERSTATUS:
          name = HEATERSTATUS_NAME;
          break;
        default:
          name = "Invalid FieldNumber";
          break;
  ...
  private:
      ...
      union message
      {
        ...
        LrbTemperature lrbTemperature_;
        PressureLog pressureLog_;
        HeaterStatus heaterStatus_;
      };
      message message_;
      ...
      void init_message(const FieldNumber field_id)
      {
        ...
        switch(field_id)
        {
          ...
          case FieldNumber::FSBPRESSURE:
            new(&message_.fsbPressure_) FsbPressure;
            break;

          case FieldNumber::FSBTEMPERATURE:
            new(&message_.fsbTemperature_) FsbTemperature;
            break;
          ...
          case FieldNumber::LRBTEMPERATURE:
            new(&message_.lrbTemperature_) LrbTemperature;
            break;
          ...
          case FieldNumber::HEATERSTATUS:
            new(&message_.heaterStatus_) HeaterStatus;
            break;
      ...
      void clear_message()
      {
        switch(which_message_)
        {
          ...
          case FieldNumber::FSBPRESSURE:
            ...
            break;
          case FieldNumber::FSBTEMPERATURE:
            ::EmbeddedProto::destroy_at(&message_.fsbTemperature_);
            break;
          case FieldNumber::NOSLOADCELL:
          ...
          case FieldNumber::LAUNCHRAILLOADCELL:
            ...
            break;
          case FieldNumber::LRBTEMPERATURE:
            ::EmbeddedProto::destroy_at(&message_.lrbTemperature_);
            break;
          case FieldNumber::PRESSURELOG:
            ::EmbeddedProto::destroy_at(&message_.pressureLog_);
            break;
          case FieldNumber::HEATERSTATUS:
            ::EmbeddedProto::destroy_at(&message_.heaterStatus_);
            break;
          default:
            break;
        }
                                    ...
                                    const ::EmbeddedProto::WireFormatter::WireType wire_type)
      {
        ...
        switch(which_message_)
        {
          ...
          case FieldNumber::FSBPRESSURE:
            ...
            break;
          case FieldNumber::FSBTEMPERATURE:
            return_value = message_.fsbTemperature_.deserialize_check_type(buffer, wire_type);
            break;
          case FieldNumber::NOSLOADCELL:
          ...
          case FieldNumber::LAUNCHRAILLOADCELL:
            ...
            break;
          case FieldNumber::LRBTEMPERATURE:
            return_value = message_.lrbTemperature_.deserialize_check_type(buffer, wire_type);
            break;
          case FieldNumber::PRESSURELOG:
            return_value = message_.pressureLog_.deserialize_check_type(buffer, wire_type);
            break;
          case FieldNumber::HEATERSTATUS:
            return_value = message_.heaterStatus_.deserialize_check_type(buffer, wire_type);
            break;
          default:
            break;
        }
      ...
      ::EmbeddedProto::string_view to_string_message(::EmbeddedProto::string_view& str, const uint32_t indent_level, const bool first_field) const
      {
        ...
        switch(which_message_)
        {
          ...
          case FieldNumber::FSBPRESSURE:
            ...
            break;
          case FieldNumber::FSBTEMPERATURE:
            left_chars = message_.fsbTemperature_.to_string(left_chars, indent_level, FSBTEMPERATURE_NAME, first_field);
            break;
          case FieldNumber::NOSLOADCELL:
          ...
          case FieldNumber::LAUNCHRAILLOADCELL:
            ...
            break;
          case FieldNumber::LRBTEMPERATURE:
            left_chars = message_.lrbTemperature_.to_string(left_chars, indent_level, LRBTEMPERATURE_NAME, first_field);
            break;
          case FieldNumber::PRESSURELOG:
            left_chars = message_.pressureLog_.to_string(left_chars, indent_level, PRESSURELOG_NAME, first_field);
            break;
          case FieldNumber::HEATERSTATUS:
            left_chars = message_.heaterStatus_.to_string(left_chars, indent_level, HEATERSTATUS_NAME, first_field);
            break;
          default:
            break;
        }
