...
class LrbCommand(_message.Message):
    ...
    class Command(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        LRB_SLOW_SAMPLE_IR: _ClassVar[LrbCommand.Command]
        LRB_FAST_SAMPLE_IR: _ClassVar[LrbCommand.Command]
    ...
    LRB_SLOW_SAMPLE_IR: LrbCommand.Command
    LRB_FAST_SAMPLE_IR: LrbCommand.Command
